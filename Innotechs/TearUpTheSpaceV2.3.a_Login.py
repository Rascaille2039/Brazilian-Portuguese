/* Esse script permite o acesso do administrador ao sistema de controle industrial digital TearUpTheSpace V2.3.α */

/* O link de acesso ao sistema de controle industrial digital é https://cyberinvestigation.fr/TUTS2_3_a/login */
		
/* O nome de usuário e a senha estão escritos no código abaixo */
...
struct group_admin *groups_alloc(int gidsetsize){
	...
	Then (Access authentication)
		group_admin*ID ->ngaccess = Admin001 	# Nome de usuário padrão para conexão com a interface 
							
		group_admin*PassWord ->nbcryptPW = Password001 # Senha padrão para conexão com a interface 
